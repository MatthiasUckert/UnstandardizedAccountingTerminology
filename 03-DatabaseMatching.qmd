...
create_interactive_table(
  .data = lst_matching$`Worldscope-Income Statement`,
  .page_length = 10L,
...
create_interactive_table(
  .data = lst_matching$`Worldscope-Balance Sheet`,
  .page_length = 10L,
  .column_align = c("left", "left", "left"),
  .header_align = "left",
  .filter = "none",
...
create_interactive_table(
  .data = lst_matching$`Compustat-Income Statement`,
  .page_length = 10L,
  .column_align = c("left", "left", "left"),
  .header_align = "left",
  .filter = "none",
...
create_interactive_table(
  .data = lst_matching$`Compustat-Balance Sheet`,
  .page_length = 10L,
  .column_align = c("left", "left", "left"),
  .header_align = "left",
  .filter = "none",
